...
UPTEST_INPUT_MANIFESTS=${SAMPLES}/vhost.yaml,${SAMPLES}/queue.yaml,${SAMPLES}/exchange.yaml,${SAMPLES}/user-secret-pass.yaml,${SAMPLES}/permissions.yaml
...
dev-init: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider RabbitMq CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(KUBECTL) apply -f examples/provider/development
...
# This target prepares repo for your provider by replacing all "rabbitmq"
