...
// SetupGated adds a controller that reconciles Permissions managed resources with safe-start support.
...
func Setup(mgr ctrl.Manager, o controller.Options) error {
	...
	if o.MetricOptions != nil && o.MetricOptions.MRStateMetrics != nil {
		...
		if err := mgr.Add(stateMetricsRecorder); err != nil {
			return errors.Wrap(err, "cannot register MR state metrics recorder for kind v1alpha1.Permissions")
		}
	}

	r := managed.NewReconciler(mgr, resource.ManagedKind(v1alpha1.PermissionsGroupVersionKind), opts...)
